...
const HeroSection =({openSignIn, openSignUp}) => {
    return (
        ...
        <div className="max-w-7xl-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pg-28">
                <div className="text-center">
                    <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:5xl md:text-6xl">
                        <span className="block">Share Files Easily and Securely with</span>
  ...
  openSignIn();
           ...
           <div className="mt-8 text-center">
            <p className="mt-4 text-base text-gray-500">Experience seamless file sharing and collaboration</p>
           </div>
        </div>
        </div>
